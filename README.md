...
<h3 align="center">🚀 Machine Learning Engineer, Researcher, and ICT Student @ Islamic University Bangladesh</h3>
...
🔬 Currently, I'm passionately delving into **Machine Learning** and **Deep Learning**, while contributing to cutting-edge **Bioinformatics** research.

🌱 I'm a lifelong learner, always seeking to expand my knowledge and expertise. I have a particular interest in **Graph Neural Networks**, **Computer Vision**, **Image Processing**, and I'm eager to venture into **Natural Language Processing (NLP)**.

💼 Let's collaborate on exciting research projects! I'm open to exploring new opportunities, so feel free to reach out if you share my passion.
